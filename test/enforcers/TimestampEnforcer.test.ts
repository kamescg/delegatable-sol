...
describe("TimestampEnforcer", () => {
  ...
  it("should SUCCEED to INVOKE method AFTER timestamp reached", async () => {
      ...
      [
        {
          enforcer: TimestampEnforcer.address,
          terms:
            "0x00000000000000000000000000000000000000000000000000000007915eda10",
        },
      ]
    );
    const INVOCATION_MESSAGE = {
